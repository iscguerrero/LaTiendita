<?php $this->layout('Layout', ['title'=>'mSV::Historial de Ingresos', 'sitepage'=>'Historial de Ingresos'])?>
<?php $this->start('css')?>
	...
	<div class="col-md-12">
		<div class="card card-plain">
			...
			<div class="table-responsive">
				<table id="tablaIngresos" class="table-condensed"></table>
			</div>
		</div>
	</div>
</div>
...
<div id="toolbar">
	<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalIngresos"><i class="fa fa-filter"></i> Filtros</button>
</div>
...
<?php $this->start('js')?>
	...
	<script src="<?php echo base_url('public/js/Inventarios/HistorialIngresos.js') ?>"></script>
<?php $this->stop()?>