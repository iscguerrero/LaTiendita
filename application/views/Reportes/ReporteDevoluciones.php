<?php $this->layout('Layout', ['title'=>'mSV::Reporte de Devoluciones', 'sitepage'=>'Reporte de Devoluciones'])?>
<?php $this->start('css')?>
	...
	<div class="card-content">
		<div class="pull-right">
			<span class="label label-success">
				<font id="ndevoluciones"></font> devoluciones
			</span>
		</div>
		<h6 class="big-title">
			<span class="text-muted">Devoluciones por día</span>
		</h6>
...
<?php $this->start('js')?>
	...
	<script src="<?php echo base_url('public/js/Reportes/ReporteDevoluciones.js') ?>"></script>
<?php $this->stop()?>